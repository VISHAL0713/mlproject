...
class DataTransformation():
    ...
    def get_data_transformer_object(self):
        ...
        This function is responsible for data transformation like:
        1.Encoding,
        2.Imputation
        3.Scaling
        ...
        try:
            ...
            logging.info('Prpeprocessing of the data is done')
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            input_test_arr = preprocessing_obj.fit_transform(input_feature_test_df)
